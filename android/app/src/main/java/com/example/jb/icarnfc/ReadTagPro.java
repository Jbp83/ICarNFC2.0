...
public class ReadTagPro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_tag_pro);
    ...
    public void onResume() {
        ...
        if (adapter != null && adapter.isEnabled()) {
            ...
            Toast.makeText(ReadTagPro.this, "Veuillez activer votre NFC dans vos Réglages", Toast.LENGTH_LONG).show();
        }
